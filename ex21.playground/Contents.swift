...
optionalCasted =  UnivStudent()

//as! 연산자 : nil임을 각오하고 강제 형변화을 해달라
var forcedCated : Student?
//forcedCated = grandFafa as! UnivStudent
//forcedCated = fafa as! UnivStudent
forcedCated = son as! UnivStudent
